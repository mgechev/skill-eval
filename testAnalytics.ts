import { calculateNormalizedGain, AnalyticsEngine } from './analytics';
...
async function testAnalytics() {
  ...
  const mockReports: EvalReport[] = [
    { task: 'task1', pass_rate: 0.5, trials: [], skills_used: [] }, // No skill
    { task: 'task1', pass_rate: 1.0, trials: [], skills_used: ['skill1'] }, // With skill
    { task: 'task2', pass_rate: 0.0, trials: [], skills_used: [] }, // No skill
    { task: 'task2', pass_rate: 0.5, trials: [], skills_used: ['skill1'] }, // With skill
  ];
